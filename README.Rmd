...
Note that the versions can be different between CRAN and currently version 0.3.0 on CRAN doesn't include the Covid-19 data but version 0.3.1 from GitHub does.
