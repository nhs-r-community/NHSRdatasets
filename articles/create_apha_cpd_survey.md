# Create dataset: apha_cpd_survey
...
form on the web page, either manually by clicking the button on the
page, or by simulating the form submission using form headers within an
{httr2} pipeline.

HTML form code, copied from above URL, and used as source for form
headers:
