...
Community
pages](https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/deaths/datasets/weeklyprovisionalfiguresondeathsregisteredinenglandandwales).
This was original a vignette and the text and code has been moved to be
an NHS-R Community
[blog](https://nhsrcommunity.nhsrcommunity.com/blog/building-the-ons-mortality-dataset.html).
...
Column names that are not related to data points to be removed. This is
the same for all years’ spreadsheets. Note that single quotes are used
for the categories as one sentence includes ’’ in the text (4).
