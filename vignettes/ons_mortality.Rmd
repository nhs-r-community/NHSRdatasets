...
vignette: >
  %\VignetteIndexEntry{ons_mortality dataset}
...
- __counts:__ character, numbers of deaths in whole numbers and average numbers with decimal points. To retain the integrity of the format this column data is left as character.
...
- __tidyverse:__ specifically dplyr for data manipulation. 
