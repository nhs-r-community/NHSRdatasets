---
title: "Dataset: A simulated hospital length-of-stay (LOS)"
author: "Chris Mainey"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Dataset: A simulated hospital length-of-stay (LOS)}
...
The data were created specifically for regression tutorials, simulating a small set of data on hospital in-patient spells.  The data are 10 sets of 30 simulated patient records, representing 10 different hospitals ("Trusts").  
