...
Where these are not applicable the licence and attribution will be the default open licences used and referenced by NHS-R Community.
...
Vignettes should use [tidyverse](https://tidyverse.org/) functions and coding style, avoiding base R and `data.table` as `tidyverse` is currently the coding style for NHS-R Community. 
