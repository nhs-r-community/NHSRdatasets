---
title: "Create dataset: ons-mortality"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Create dataset: ons-mortality}
...
This was original a vignette and the text and code has been moved to be an NHS-R Community [blog](https://nhsrcommunity.nhsrcommunity.com/blog/building-the-ons-mortality-dataset.html).
